...
const GeneralSection: React.FC<GeneralSectionProps> = ({
    ...
    pinnedPrompts, setPinnedPrompts,
}) => {
        ...
        <>
            <div className={styles.settingsPanel}>
                <div className={styles.settingsPanelHeader}>
                    ...
                    <p className={styles.settingsPanelSubtitle}>Customize the quick prompts shown on the home screen.</p>
                </div>
                    ...
                    <label className={styles.toggleRow}>
                        <div className={styles.toggleInfo}>
                            ...
                            <div>
                                ...
                                <span className={styles.toggleDescription}>Show a badge on the extension icon when automations complete.</span>
                            </div>
                        </div>
                        <input
                            type="checkbox"
                    ...
                    <label className={styles.toggleRow}>
                        <div className={styles.toggleInfo}>
                            ...
                            <div>
                                ...
                                <span className={styles.toggleDescription}>Keep a record of past automations and chats on this device.</span>
                            </div>
                        </div>
                        <input
                            type="checkbox"
